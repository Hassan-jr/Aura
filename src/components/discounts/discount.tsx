...
import { CalendarIcon, PercentIcon, ShoppingBagIcon, UserIcon } from 'lucide-react'
            ...
            <CardContent>
              ...
              <div className="mt-4 grid grid-cols-2 gap-4">
                ...
                <div className="flex items-center">
                  ...
                  <span className="text-sm">Product ID: {discount.productId}</span>
                </div>
                <div className="flex items-center">
                  <PercentIcon className="mr-2 h-4 w-4 text-muted-foreground" />
                  <span className="text-sm">Discount Rate: {discount.agreedDiscountRate}%</span>
                </div>
              </div>
            </CardContent>
          </Card>
